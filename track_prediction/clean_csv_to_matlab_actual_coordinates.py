...
data_file_path = os.path.join(os.getcwd(),'data','northindianocean', 'northindianocean.csv') 
new_mat_file_path_train = os.path.join(os.getcwd(), 'data','northindianocean', 'actual_northindianocean_train.mat')
new_mat_file_path_test = os.path.join(os.getcwd(), 'data','northindianocean', 'actual_northindianocean_test.mat')
